...
- 实际实现见 `scripts/generate-bundled-small-bodies.py`、`SmallBody.java`、`SmallBodyEphemeris.java`、`SmallBodyCatalog.java`、`BundledSmallBodies.java`,与 `MainActivity` 设置页的"小行星 / 彗星"分组。
